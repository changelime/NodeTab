...
$__System.register("1f", ["20", "1d", "1e"], function (_export) {
	var util, _createClass, _classCallCheck, Obj;
		...
		execute: function () {
			...
			Obj = (function () {
				...
				_createClass(Obj, [{
					...
					key: "calculate",
					value: function calculate(noFri) {
						var x = 0;
						var y = 0;
...
$__System.register("21", ["e", "1a", "1d", "1e", "1f"], function (_export) {
	var _get, _inherits, _createClass, _classCallCheck, Obj, Node;
		...
		execute: function () {
			...
			Node = (function (_Obj) {
				...
				function Node(x, y, radius) {
					...
					_get(Object.getPrototypeOf(Node.prototype), "constructor", this).call(this, x, y, radius * 2, radius * 2);
					this._radius = radius;
					this.vs = {};
					this.mass = 1;
				}
...
$__System.register("20", [], function (_export) {
	...
	return {
		...
		execute: function () {
			util = {
				connectWithLine: function connectWithLine(context, now, target, color) {
					context.save();
				...
				radToAng: function radToAng(rag) {
					return rag * Math.PI / 180;
				},
				getOffset: function getOffset(fixed, ball, offset) {
				...
				decomposeVelocity: function decomposeVelocity(angle, force) {
					return {
...
$__System.register("25", [], function (_export) {
	...
	return {
		...
		execute: function () {
			color = {
				hashToRGB: function hashToRGB(hash, a) {
					hash = hash.slice(1);
				...
				RGBToHash: function RGBToHash(r, g, b) {
				...
				fillNumber: function fillNumber(str, maxLen, number) {
					var len = str.length;
					if (len < maxLen) {
						var need = maxLen - len;
				...
				toNumber: function toNumber(numStr) {
    ...
    return {
        ...
        execute: function () {
            setting = {
                ...
                downStatus: function downStatus() {
                    var status = this.getStatus();
                    if (status > 0) {
                        status--;
                    }
